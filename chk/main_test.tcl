...
add wave -noupdate -expand -group MEM -expand -group {Forwarding Unit} /TestBench/CPU/FwdUnit/IDEX_Rs
add wave -noupdate -expand -group MEM -expand -group {Forwarding Unit} /TestBench/CPU/FwdUnit/IDEX_Rt
add wave -noupdate -expand -group MEM -expand -group {Forwarding Unit} /TestBench/CPU/FwdUnit/EXMEM_Rd
add wave -noupdate -expand -group MEM -expand -group {Forwarding Unit} /TestBench/CPU/FwdUnit/MEMWB_Rd
