...
add wave -noupdate -label Clock -radix binary /Memory_TestBench/mem_dut/clk
add wave -noupdate -divider Input
add wave -noupdate -label Address -radix hexadecimal -radixshowbase 0 /Memory_TestBench/mem_dut/addr_i
add wave -noupdate -label CS -radix binary /Memory_TestBench/mem_dut/cs
add wave -noupdate -label WE -radix binary /Memory_TestBench/mem_dut/we
...
WaveRestoreCursors {{Cursor 1} {2130 ps} 0}
...
update
WaveRestoreZoom {1870 ps} {2846 ps}
