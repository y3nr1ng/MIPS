...
add wave -noupdate -expand -group CPU -expand -group {Program Counter} -radix decimal /Cache_TestBench/CPU/PC/addr_i
add wave -noupdate -expand -group CPU -expand -group {Program Counter} -radix decimal /Cache_TestBench/CPU/PC/addr_o
...
add wave -noupdate /Cache_TestBench/CPU/L1Cache/p1_addr_i
...
add wave -noupdate -radix hexadecimal /Cache_TestBench/CPU/instr_imm
